...
между                более               правой               парой               соседних               слов.""")
        ...
        alignFileByWidth("input/kotoed.txt", "temp.txt")
        assertFileContent("temp.txt",
                """БАЮЗЖФБ                тб                ТфЁН                /                ЛбйЗбаЩ:                ТБ
абЗЩНабя --- ЯЦБ - аксрдбвраш баюзжфб: БУА, баюЗЖФб -- АКСРДБВРАШ, буа - ЛБЙЗБАЩ - баюЗЖФб / чвюбввб ЯЦБ
ТфЁН                            /                            ЛБЙЗБАЩ:                            ЧвЮбвВб
ЯЦБ          /          тб:          бавЖа          БАВЖА,          АБЗЩНАБЯ          /          РБУЮЗБА
РбуЮзба      --      РБУЮЗБА     ---     ТФЁН     тфён;     ЛБЙЗБАЩ     --     бр,     БАВЖА     РБУЮЗБА
лбйзбащ""")
        File("temp.txt").delete()
